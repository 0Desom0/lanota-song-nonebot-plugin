...
allowed_groups = {1037559220, 551374760, 565752728, 1006108282, 1034528298, 790208848, 767569571}  # 白名单群组，只有这些群才会触发
alias_groups = {1037559220, 767569571}  # 白名单群组，只有这些群才会触发
